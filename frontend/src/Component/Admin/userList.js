...
export default function UserList(){
    ...
    let {user,users=[],error,loading,isUserDeleted}=useSelector((state)=>state.userState)
            ...
            data.rows.push({
                ...
                actions:(
                    <Fragment>
                        ...
                        <Button onClick={(e)=>handleDelete(e,user._id)} className='btn btn-danger py-1 px-2 ml-2'>
