...
export default function OrderList(){
    ...
    let {adminOrders=[],loading=true,error,isOrderDeleted,isOrderUpdated}=useSelector((state)=>state.orderState)
            ...
            data.rows.push({
                ...
                action:(
                    <Fragment>
                        ...
                        <Button onClick={(e)=>handleDelete(e,order._id)} className='btn btn-danger py-1 px-2 ml-2'>
    ...
    useEffect(()=>{
        ...
        if (isOrderDeleted) {
            toast.success("Order Deleted successfully!", {
              ...
              onOpen:()=>{dispatch(clearOrderDelete())}
            });
            return;
          }
